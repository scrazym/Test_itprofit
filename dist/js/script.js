...
/* harmony import */ var _validation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./validation */ "./src/js/modules/validation.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postdata)("http://localhost:9090/api/registration", json).then(data => {
...
const isValid = () => {
  ...
  items.forEach(item => {
    item.addEventListener("change", function () {
      switch (item.name) {
        case "name":
          item.value.length < 2 ? (item.parentNode.classList.add("order__input-error"), btnRecall.disabled = true) : (item.parentNode.classList.remove("order__input-error"), btnRecall.disabled = false);
          break;
        case "email":
          !regEmail.test(item.value) ? (item.parentNode.classList.add("order__input-error"), btnRecall.disabled = true) : (item.parentNode.classList.remove("order__input-error"), btnRecall.disabled = false);
          break;
        case "phone":
          const phoneMask = new imask__WEBPACK_IMPORTED_MODULE_0__["default"](item, {
            mask: "+{7}(000)000-00-00"
          });
          !phoneMask.masked.isComplete ? (item.parentNode.classList.add("order__input-error"), btnRecall.disabled = true) : (item.parentNode.classList.remove("order__input-error"), btnRecall.disabled = false);
          break;
        case "text":
          item.value.length < 15 ? (item.parentNode.classList.add("order__input-error"), btnRecall.disabled = true) : (item.parentNode.classList.remove("order__input-error"), btnRecall.disabled = false);
      }
    });
  });
};
...
/* harmony import */ var _modules_validation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/validation */ "./src/js/modules/validation.js");




window.addEventListener("DOMContentLoaded", () => {
  const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)(".modal", modalTimerId), 60000);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__.timer)(".timer", "2023-12-12");
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_0__.modal)("[data-modal]", ".modal", modalTimerId);
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_2__.forms)("form", modalTimerId);
  (0,_modules_validation__WEBPACK_IMPORTED_MODULE_3__.isValid)();
});
})();
